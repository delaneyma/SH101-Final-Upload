...
class AboutTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 1 && indexPath.row == 0 {
            ...
            cell.AboutP2Label2.text = "Now more than ever, your “assessment and plan” as a health care provider has to be socially conscious. In the current landscape where a person’s race, culture, or socioeconomic status has been shown to directly influence their health outcomes, we don’t have to convince most providers that the “social determinants of health” are incredibly important. Our observation is that most clinicians have the desire to provide comprehensive and socially impactful health care, but many of them lack the 'know-how' to deliver that care. Enter 'Social Health 101,' the app. #SH101 is a mobile reference tool aimed at bridging the gap between talking about and practicing socially conscious health care. Through condensed and easy-to-understand synopsis pages, SH101 compiles, organizes, and teaches both what resources are available and what you need to know to use those resources to better take care of your most vulnerable patients. Every page in #SH101 contains helpful links and contact info for reference whether you need it in the clinic, hospital, or at home. Program topics include programs for children, pregnant women, immigrants, refugees, the uninsured, those suffering from food/housing insecurity, those in need of legal aid, and more."
            return cell}
